import kanbanImage from "../../../public/image/customizable-task-board.png";
export const featuresDemoData = {
  id: 1,
  features: [
    {
      id: 1,
...

    {
      ...
      description:
        "Manage your projects with ease. Create and assign tasks, set due dates, and track progress with ease.",
      image: "/pm.png",
      keyPoints: [
        {
          id: 1,
        ...
        },
        {
          ...
          description:
            "Track issues and bugs with ease. Assign issues to team members and keep track of progress.",
        },
        {
          id: 4,
          title: "Income",
          description:
            "Income feature allows you to track your income and expenses. You can also create invoices and send them to your clients.",
        },
        {
          id: 5,
          title: "Expense",
        ...
        },
        {
          ...
          title: "Budget",
          description:
            "Budget can be created for each project. You can also create a budget for your company.",
        },
      ],
    },
    {
