...
const ContactSupport = ({ supportData }) => {
  ...
  return (
    ...
    >
      <div className={`${styles.supportWrapper} container-lg`}>
        <div className={`${styles.supportInnerWrapper} `}>
            ...
            <div className={`${styles.users}`}>
              {supportData?.support?.usersList?.users?.map((user, index) => (
                <p
                  ...
                  style={{
                    backgroundColor:
                      selectedUser === user.title ? "#173465" : "",
          ...
          <hr />
          {/* questions section */}
          {supportData?.support?.usersList?.questionsSection.map(
            (questions) => (
              <div
              ...
              >
                <h4 className={`${styles.accordionWrapperLeft}`}>
                  {selectedUser === questions.user &&
                    questions.questionsList.title}
                </h4>
